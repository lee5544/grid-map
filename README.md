...
The codes are implemented on the ROS. We will release the source code soon. For codes, please email us. And the corridor dataset can be found at this repository.
